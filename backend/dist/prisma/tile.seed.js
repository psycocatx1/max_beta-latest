...
exports.seedTileProducts = void 0;
const seedTileProducts = async (prisma) => {
    ...
    try {
        ...
        for (const locale of locales) {
            for (const product of products) {
                try {
                    const translation = tileTranslations[product.name]?.[locale.language];
                    if (!translation) {
...
exports.seedTileProducts = seedTileProducts;
//# sourceMappingURL=tile.seed.js.map