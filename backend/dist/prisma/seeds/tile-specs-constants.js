...
exports.ECO_SAFETY_TERMS = exports.INSTALLATION_TERMS = exports.TECH_TERMS = exports.COMMON_STANDARDS = exports.TILE_TECH_SPECS = void 0;
exports.generateTechSpecs = generateTechSpecs;
exports.generatePhysicalProps = generatePhysicalProps;
exports.TILE_TECH_SPECS = {
    '600x600x9.5': {
        size: '600×600×9.5mm',
        weight_per_m2: 22,
        tiles_per_package: 5,
...
function generateTechSpecs(size, lang, variant) {
    const specs = exports.TILE_TECH_SPECS[size];
    const terms = exports.TECH_TERMS[lang];
    const standards = exports.COMMON_STANDARDS;
...
function generatePhysicalProps(lang) {
    const terms = exports.TECH_TERMS[lang];
    const standards = exports.COMMON_STANDARDS;
    return [
...
//# sourceMappingURL=tile-specs-constants.js.map