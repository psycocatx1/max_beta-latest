...
export const Logo = ({ className, width, height }: LogoProps) => (
  <svg className={className} width={width} height={height} viewBox="0 0 1355 460" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M639.5 187V255.5" stroke="#CE6C00" strokeWidth="5" />
    <path d="M1347.5 4V453.694L167.724 4H1347.5Z" fill="#2B3205" stroke="black" strokeWidth="8" />
    <path d="M1350.5 0V460" stroke="#F4FE40" strokeWidth="8" />
    ...
    <line x1="711" y1="303" x2="711" y2="261" stroke="#BB7C01" strokeWidth="2" />
    <defs>
      <filter id="filter0_d_1_264" x="343.449" y="334.455" width="666.661" height="101.545" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
